...
You are the **memory-search** worker in this czarina orchestration.

## Your Role
Build semantic search with vector embeddings

## Your Instructions
Full task list: $(pwd)/../workers/memory-search.md

Read it now:
```bash
cat ../workers/memory-search.md | less
```

Or use this one-liner to start:
```bash
cat ../workers/memory-search.md
```

## Quick Reference
- **Branch:** cz1/feat/memory-search
- **Location:** /home/jhenry/Source/czarina/.czarina/worktrees/memory-search
- **Dependencies:** None
...
## Your Mission
1. Read your full instructions at ../workers/memory-search.md
